...
function mediaCheck(audioplayer, stream) {
    if (FlashDetect.versionAtLeast(10)) {
        audioplayer.innerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="130" height="60" bgcolor="#FFFFFF"><param name="movie" value="ffmp3-tiny.swf" /><param name="flashvars" value="url=' + stream + '&lang=auto&codec=mp3&volume=100&introurl=&tracking=true&jsevents=false&buffering=5&title=CarnavalRadio" /><param name="wmode" value="window" /><param name="allowscriptaccess" value="always" /><param name="scale" value="noscale" /><embed src="ffmp3-tiny.swf" flashvars="url=' + stream + '&lang=auto&codec=mp3&volume=100&introurl=&tracking=true&jsevents=false&buffering=5&title=CarnavalRadio" width="130" scale="noscale" height="60" wmode="window" bgcolor="#FFFFFF" allowscriptaccess="always" type="application/x-shockwave-flash" /></object>';
    }
    else if (wmpDetect) {
        audioplayer.innerHTML = '<object id="mediaplayer" classid="6BF52A52-394A-11d3-B153-00C04F79FAA6" codebase="http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#version=5,1,52,701" standby="loading microsoft windows media player components..." type="application/x-oleobject" width="200" height="40"><param name="filename" value="AudioStreams/Carnaval-Radio.asx"><param name="animationatstart" value="true"><param name="transparentatstart" value="true"><param name="autostart" value="false"><param name="showcontrols" value="true"><param name="ShowStatusBar" value="true"><param name="windowlessvideo" value="true"><embed src="AudioStreams/Carnaval-Radio.asx" autostart="false" showcontrols="true" showstatusbar="1" bgcolor="white" width="200" height="40"></object>';
    }
    else {
